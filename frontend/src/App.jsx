      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!dashboard ? (
          ...
          <>
              ...
              <>
                ...
                <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                    ...
                    <div className="bg-zinc-800 rounded-xl p-4 border border-zinc-700">
                      <p className="text-sm text-zinc-400 mb-1">Priority</p>
            ...
            {["owner", "warehouse"].includes(selectedRole) && (
            ...
            {["owner", "support"].includes(selectedRole) && (
              <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800 mt-8">
                <h2 className="text-2xl font-semibold mb-4">
                  Recent Orders
                </h2>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left">
                    ...
                    <tbody>
                      {(showAllOrders ? orders : orders.slice(0, 5)).map(
                        (order) => (
                          <tr
                            key={order.id}
